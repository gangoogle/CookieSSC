...
fun getTrendDetailData(): Map<String, TrendDetailItem> {
    return mapOf(
            "qlc" to TrendDetailItem(12123040f,65.2f,30f,12f,
                    listOf(
            ...
            "ssq" to TrendDetailItem(2660200f,80f,90f,40f,
                    listOf(
            ...
            "dlt" to TrendDetailItem(3522310f,90f,60f,32f,
                    listOf(
            ...
            "bj11x5" to TrendDetailItem(24123100f,25f,10f,22f,
                    listOf(
                            LinePercentData("一等奖",92,false),
                            LinePercentData("二等奖",120,false),
                            LinePercentData("三等奖",110,false),
            ...
            "qxc" to TrendDetailItem(1533202f,72.5f,30f,12f,
                    listOf(
                            LinePercentData("一等奖",92,false),
                            LinePercentData("二等奖",120,false),
                            LinePercentData("三等奖",110,false),
            ...
            "bjk3" to TrendDetailItem(1067000f,25f,10f,22f,
                    listOf(
                            LinePercentData("一等奖",92,false),
                            LinePercentData("二等奖",120,false),
                            LinePercentData("三等奖",110,false),
            ...
            "pl3" to TrendDetailItem(430522300f,25f,20f,32f,
                    listOf(
                            LinePercentData("一等奖",12,false),
                            LinePercentData("二等奖",180,false),
                            LinePercentData("三等奖",110,false),
            ...
            "pl5" to TrendDetailItem(1942080f,90f,60f,32f,
                    listOf(
                            LinePercentData("一等奖",122,false),
                            LinePercentData("二等奖",120,false),
                            LinePercentData("三等奖",70,false),
